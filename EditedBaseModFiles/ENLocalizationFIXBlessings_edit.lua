...
--____________________________________________________enmbler
...
{	id = "trait_bespoke_107_desc_ext_en", -- Punishing Fire
	...
	locales = {"en",}, handle_func = function(locale, value)
	return p_pwr_lvl_var_rgb .. " " .. power_rgb .. " Bonus on your ranged attack for " .. time_var_rgb .. " seconds after сleaving through several enemies with your weapon's Special attack." .. pwr_note_rgb end}, -- colors
