...
{	id = "talent_tree_oper_mod_000_l_desc_en", -- toughness:+15%.
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{toughness:%s} " .. toughness_rgb .. ".\n\n- Stacks additively with other Toughness nodes.\n- Current max Toughness is multiplied by the Toughness percentage buffs from Curios." end}, -- colors
--_____________________________________________________Toughness Boost
...
{	id = "talent_tree_oper_mod_002_l_desc_en", -- toughness:+5%.
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{toughness:%s} " .. toughness_dmg_rgb .. " Reduction.\n\n- Stacks additively with other Toughness Damage Reduction nodes.\n- Their sum stacks multiplicatively with other Damage Reduction buffs." end}, -- colors
--_____________________________________________________Toughness Damage Reduction
...
{	id = "talent_tree_oper_mod_001_desc_en", -- warp_charge:-5%.
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{warp_charge:%s} " .. peril_rgb .. " Generation.\n\n- Stacks multiplicatively with other nodes and related Peril cost reduction buffs from \"Becalming Eruption\", \"Inner Tranquility\", \"Kinetic Resonance\", \"Reality Anchor\"." end}, -- colors
...
{	id = "talent_tree_oper_mod_004_desc_en", -- ranged_damage:+5%.
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{ranged_damage:%s} Ranged " .. damage_rgb .. ".\n\n- Stacks additively with other related Damage buffs." end}, -- colors
...
{	id = "talent_tree_oper_mod_006_desc_en", -- crit_chance:+5%.
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{crit_chance:%s} " .. crit_hit_chance_rgb .. ".\n\n- Stacks additively with other sources of Crit Chance." end}, -- colors
...
{	id = "talent_tree_oper_mod_007_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{movement_speed:%s} Movement Speed.\n\n- Stacks additively with related buffs from \"Disrupt Destiny\", \"Mettle\", \"Warp Speed\" and weapon Blessings like \"Rev it Up\"." end}, -- movement_speed:+5%.
...
{	id = "talent_tree_oper_mod_008_desc_en", -- melee_damage:+5%.
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{melee_damage:%s} Melee " .. damage_rgb .. ".\n\n- Stacks additively with other Melee Damage nodes and other related Damage buffs." end}, -- colors
...
{	id = "talent_tree_oper_mod_009_desc_en", -- stamina:+1.
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{stamina:%s} " .. stamina_rgb .. ".\n\n- Stacks additively with Stamina values from Curios, weapon Perks and weapon Stamina profiles." end},
...
{	id = "talent_tree_oper_mod_010_desc_en", -- suppression:+25%.
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{suppression:%s} Suppression Dealt.\n\n- Stacks additively with Suppression buff from weapon Blessing \"Powderburn\"." end},
...
{	id = "talent_tree_oper_mod_011_desc_en", -- reload_speed:+5%.
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{reload_speed:%s} Reload Speed.\n\n- Stacks additively with Reload Speed buffs from Fleeting Fire, Marksman's Focus, Tactical Reload, Volley Adept, weapon Perks and Blessings." end},
...
{	id = "talent_tree_oper_mod_012_desc_en", -- duration:0.25.
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{duration:%s} seconds " .. stamina_rgb .. " Regeneration Delay Reduction.\n\n- Reduces base Stamina Regeneration Delay from 1 to 0.75 seconds.\n- This time is the Delay before Stamina starts Regenerating after having spent Stamina.\n- Stacks additively with the other Stamina Regeneration Delay reduction node." end}, -- s -> seconds
...
{	id = "talent_tree_oper_mod_013_desc_en", -- rending:+5%.
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{rending:%s} " .. rending_rgb .. ".\n\n- Including DoTs and explosions.\n- Only affects Ogryn's own Damage.\n- Stacks additively with other Rending buffs and with Brittleness debuffs that are applied to enemies." end}, -- colors
...
{	id = "talent_tree_oper_mod_014_l_desc_en", -- melee_heavy_damage:+5%.
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{melee_heavy_damage:%s} Heavy Melee " .. damage_rgb .. ".\n\n- Stacks additively with other Melee Damage nodes and other related Damage buffs.\n- This node also buffs the Melee Special actions from Ripper Gun, Grenadier Gauntlet (melee part), Rumbler, Stubber and Kickback." end}, -- colors
--_____________________________________________________Heavy Melee Damage Boost
...
{	id = "talent_tree_psy_blitz1_001_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Using your Combat Ability makes your {talent_name:%s} charge {smite_attack_speed:%s} faster and generate {warp_charge_cost:%s} less " .. peril_rgb .. " for {duration:%s} seconds.\n\n- Reduces charge time for:\n-- Primary attack from 2 to 1.16 seconds,\n-- Secondary attack from 3 to 1.7 seconds.\n- Charge time reduction Stacks additively with \"Empowered Psionics\" buff.\n- Peril cost reduction Stacks multiplicatively with related buffs from \"Becalming Eruption\", \"Inner Tranquility\", \"Reality Anchor\", Peril Resistance nodes and Combat Stimm." end}, -- talent_name:Brain Rupture smite_attack_speed:+75% warp_charge_cost:50% duration:10. -- colors s->seconds
...
{	id = "talent_tree_psy_blitz1_002_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "You have {smite_chance:%s} chance on any of Psyker's damaging attacks to trigger {talent_name:%s} on target. Cooldown of {time:%s} seconds.\n\n- Procs on \"Warp Rupture\".\n- \"Brain Rupture\" attacks triggered by the Talent benefit from \"Empowered Psionics'\" Damage buff without consuming a Stack.\n- Triggers at Any Peril level!" end}, -- smite_chance:10% talent_name:Brain Rupture. time:15. -- colors Notice! s->seconds
...
{	id = "talent_tree_psy_blitz2_000_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "You unleash a torrent of chain Bio-Lightning that slowly jumps between enemies, dealing low Electrocuting " .. damage_rgb .. " over time and very High " .. stagger_rgb .. " to them.\nSecondary charged attack deals more " .. damage_rgb .. " when released and also jumps faster from enemy to enemy.\n\n- Cannot crit.\n- Max range: 15 meters.\n- Charge time for secondary attack: 0.8 seconds.\n- Cannot Stagger Monstrosities and Scab Captain with active void shield.\n- Low Damage modifier against Carapace armor.\n- Targets only torso hitzone.\n- Can be affected by Damage buffs from \"Empowered Psionics\", \"Empyrean Empowerment\", \"Disrupt Destiny\", \"Malefic Momentum\", \"Perfect Timing\", \"Scrier's Gaze\", \"Warp Rider\", aura \"Kinetic Presence\" Ranged Damage node.\n- Forces a short Quelling action when reaching 100% Peril removing ~8.5% Peril. If released below 100% Peril, applies a push effect to enemies." .. smite_warn_rgb end}, -- !patch #15 -- colors Warning!
...
{	id = "talent_tree_psy_blitz2_002_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Enemies affected by your {talent_name:%s} take {damage:%s} increased Base " .. damage_rgb .. " from all sources.\n\n- The debuff is being applied as long as the enemy is actively affected by \"Smite\".\n- Stacks multiplicatively with other Damage buffs.\n- Does not Stack with the same debuff applied by another Psyker." end}, -- talent_name:Smite damage:+10%. -- colors
...
{	id = "talent_tree_psy_blitz3_002_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{talent_name:%s} charges Replenish {recharge:%s} faster.\n\n- Reduces projectile recharge time from 3 seconds to 2.1 seconds per projectile.\n- Is unaffected by the Maelstrom mutators that grant \"Enhanced Blitz\" Abilities." end}, -- talent_name:Assail recharge30%.
...
{	id = "talent_tree_psy_aura1_000_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{damage:%s} " .. damage_rgb .. " against Elite Enemies for you and Allies in Coherency.\n\n- Stacks additively with other related Damage buffs.\n- Does not Stack with the same Aura from another Psyker." end}, -- damage:+10%. -- colors
...
{	id = "talent_tree_psy_aura2_000_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{cooldown_reduction:%s} " .. ability_cd_rgb .. " Reduction for you and Allies in Coherency.\n\nThis is an augmented version of {talent_name:%s}.\n\n- Stacks additively with Combat Ability Regeneration from Curios and the Maelstrom mutators that Reduce Ability Cooldowns by 20%.\n- Does not Stack with the same Aura from another Psyker.\n- This Reduces the Cooldowns of \"Venting Shriek\", \"Psykinetic's Wrath\" and \"Scrier's Gaze\" to 27 seconds and the Cooldown for \"Telekine Shield\" to 36 seconds." end}, -- cooldown_reduction:+10%. talent_name:The Quickening.
...
{	id = "talent_tree_psy_aura3_000_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "You and Allies in Coherency gain {critical_strike_chance:%s} " .. crit_hit_chance_rgb .. ".\n\n- Applies to all attacks that can Crit.\n- Stacks additively with other sources of Crit Chance.\n- Does not Stack with the same Aura from another Psyker." end}, -- critical_strike_chance:+5%. (+4% before patch #15) -- colors
...
{	id = "talent_tree_psy_abil1_002_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Your {talent_name:%s} now also deals {base_damage:%s}-{max_damage:%s} " .. damage_rgb .. ", based off of your current " .. peril_rgb .. " percentage.\n\n- Base damage dealt scales with peril:\n______________________________\nPeril Amount:		Base Damage:\n0%			100\n25%			125\n50%			150\n75%			175\n100%			200\n______________________________\n- Damage is affected by Damage buffs from \"Disrupt Destiny\", \"Malefic Momentum\", \"Perfect Timing\", \"Warp Rider\", Perks and Blessings of the weapon that is equipped when Venting Shriek is used." end}, -- talent_name:Venting Shriek, base_damage:100-max_damage:200. -- colors Warning!
...
{	id = "talent_tree_psy_abil1_003_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{talent_name:%s} applies {min_stacks:%s}{warpfire_stacks:%s} Stacks of " .. soulblaze_rgb .. " to targets Hit based on your current " .. peril_rgb .. ".\n\n- Lasts 10 seconds.\n- The amount of Soulblaze stacks applied to enemies scales with Peril:\n______________________________\nSoulblaze Stacks:	Peril Required:\n1			0%\n2			16.67%\n3			33.34%\n4			50.00%\n5			66.67%\n6			83.34%\n______________________________\n- Stacks additively with other sources of Soulblaze." end}, -- talent_name:Venting Shriek min_stacks:1 warpfire_stacks:-6. -- colors () Notice!
...
{	id = "talent_tree_psy_abil2_001_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{talent_name:%s} now holds up to {max_charges:%s} charges.\n\n- The Cooldown of the second charge only starts after the first charge finished Cooldown." end}, -- talent_name:Telekine Shield max_charges:2.
...
{	id = "talent_tree_psy_abil2_003_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{talent_name:%s} now forms a spherical shield which lasts {duration:%s} seconds.\n\n- Sphere has a radius of 6 meters and protects from enemy attacks at 360 degrees.\n- Has the same properties as the flat shield.\n- Also takes Ranged Damage in the same way." end}, -- talent_name:Telekine Shield duration:25. -- colors s->seconds
...
{	id = "talent_tree_psy_abil2_004_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "All allies inside your {talent_name:%s} replenish {toughness:%s} " .. toughness_rgb .. " each second. When your {talent_name:%s} dissipates, all Allies inside gain {toughness_damage_reduction:%s} " .. toughness_dmg_rgb .. " Reduction for {duration:%s} seconds.\n\n- Stacks multiplicatively with other Damage Reduction buffs." end}, -- talent_name:Telekine Shield toughness:10%. toughness_damage_reduction:+50% duration:5. -- colors s->seconds
...
{	id = "talent_tree_psy_abil3_001_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "While overcharging, makes " .. weakspot_rgb .. " kills generate {second:%s} additional Stack.\n\nFor each second spent in {talent_name:%s}, you now also gain {finesse_damage_per_stack:%s} " .. finesse_dmg_rgb .. " bonus to " .. crit0_rgb .. "/" .. weakspot_dmg_rgb .. ", up to {max_finesse_damage:%s} max, which lingers for {duration:%s} seconds after leaving {talent_name:%s}.\n\n- Can proc multiple times per attack when Cleaving." end}, -- second:1 talent_name:Scrier's Gaze. finesse_damage_per_stack:+1% max_finesse_damage:+30% duration:10. -- colors () s->seconds Notice!
...
{	id = "talent_tree_psy_abil3_002_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Only while overcharging, {talent_name:%s} increases your Movement Speed by {movement_speed:%s}.\n\n- Does not linger after overcharging phase.\n- Stacks additively with related buffs from \"Disrupt Destiny\", \"Mettle\", Movement Speed node and weapon Blessings like \"Rev it Up\"." end}, -- talent_name:Scrier's Gaze. movement_speed:+20%.
...
{	id = "talent_tree_psy_abil3_003_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Only while overcharging, {talent_name:%s} reduces the amount of " .. peril_rgb .. " Generated by {warp_charge:%s}.\n\n- Does not linger after overcharging phase.\n- Stacks multiplicatively with related Peril cost reduction buffs from \"Kinetic Resonance\", Peril Resistance nodes and Combat Stimm.\n- Can only stack with \"Inner Tranquility\" if Psyker regains Warp Charges while overcharging." end}, -- talent_name:Scrier's Gaze warp_charge:-20%. -- colors
...
{	id = "talent_tree_psy_abil3_004_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Only while overcharging, {talent_name:%s} grants {tdr:%s} " .. toughness_dmg_rgb .. " Reduction.\n\n- Does not linger after overcharging phase.\n- Stacks multiplicatively with other Damage Reduction buffs." end}, -- talent_name:Scrier's Gaze tdr:+20%. -- colors
...
{	id = "talent_tree_psy_keys1_001_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{warp_charge_amount:%s} " .. peril_rgb .. " Generation Reduction for each Warp Charge.\n\n- Stacks multiplicatively with other related Peril cost reduction buffs from \"Kinetic Resonance\", Peril Resistance nodes and Combat Stimm.\n- Because all Warp Charges are dropped when using a Combat Ability, the Talent cannot immediately Stack with \"Becalming Eruption\" and \"Reality Anchor\", unless Psyker regains Warp Charges during their active duration." end}, -- warp_charge_amount:-6%. -- colors
...
{	id = "talent_tree_psy_keys1_002_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Replenish {toughness:%s} " .. toughness_rgb .. " over {time:%s} seconds on gaining Warp Charge. Gaining a new Warp Charge during this time resets the timer.\n\n- Replenishes 6% of maximum Toughness per second for 5 seconds.\n- Gaining a Warp Charge while the duration is active only resets the 5 seconds window, does not increase the amount of Toughness replenished.." end}, -- toughness:30% time:5. -- colors s->seconds
...
{	id = "talent_tree_psy_keys1_003_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Increases all Base " .. damage_rgb .. " by {damage:%s} for each Warp Charge.\n\n- Stacks additively with other related Damage buffs.\n- Can technically not interact with Damaging Combat Abilities because all current Warp Charges are dropped upon Combat Ability activation, i.e. before their Damage increase could take effect." end}, -- damage:+4%. -- colors
...
{	id = "talent_tree_psy_keys1_004_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Killing an Enemy with " .. soulblaze_rgb .. " has a {chance:%s} chance to grant you a Warp Charge.\n\n- Triggers regardless of who applied the Soulblaze effect.\n- All psykers with this Talent modifier have a chance to gain a Warp Charge.\n- The effect's range is Unlimited (probably)." end}, -- chance:10%. -- colors Notice!
...
{	id = "talent_tree_psy_keys1_006_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Whenever you or an Ally in Coherency kill an enemy, you have a {soul_chance:%s} chance to gain a Warp Charge.\n\n- When several Psykers are in Coherency with each other, they all receive a Warp Charge whenever the Talent procs for any of them." end}, -- soul_chance:4%.
...
{	id = "talent_tree_psy_keys2_002_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Using your Blitz while {talent_name:%s} is active replenishes {toughness:%s} " .. toughness_rgb .. " to you and Allies in Coherency.\n- Procs when \"Brain Rupture\" hits, when \"Smite\" starts casting or after charging, and when \"Assail\" spawns a projectile." end}, -- talent_name:Empowered Psionics toughness:15%. -- colors
...
{	id = "talent_tree_psy_keys3_001_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Increase the duration of {talent_name:%s} from {duration_previous:%s} seconds to {duration_after:%s} seconds." end}, -- talent_name:Disrupt Destiny duration_previous:15 duration_after:30.. -- s->seconds
...
{	id = "talent_tree_psy_keys3_002_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Killing Enemies Marked by {talent_name:%s} have a {chance:%s} chance to instantly Quell {warp_charge_percentage:%s} of your " .. peril_rgb .. ".\n\n- There is a 2% chance that the Talent procs on the same kill alongside \"Battle Meditation\" removing 25% Peril total." end}, -- talent_name:Disrupt Destiny chance:20% warp_charge_percentage:15%.. -- colors
...
{	id = "talent_tree_psy_keys3_003_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Maximum " .. precision_rgb .. " Bonus stacks are increased from {stacks_previous:%s} to {stacks_after:%s}." end}, -- stacks_previous:15 stacks_after:30. -- colors
...
{	id = "talent_tree_psy_keys3_004_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return weakspot_rgb .. " Kills grant {stacks:%s} additional Stacks of {talent_name:%s}.\n\n- Procs on Melee, Ranged, \"Brain Rupture\" or \"Assail\" attacks." end}, -- stacks:2 talent_name:Disrupt Destiny.
...
{	id = "talent_tree_psy_pas_002_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Replenish {toughness:%s} " .. toughness_rgb .. " for each {warp_charge:%s} of " .. peril_rgb .. " Quelled.\n\n- Replenishes 0.5% of maximum Toughness per 1% Peril Quelled.\n- Active or passive Quelling makes no difference. For example, a Psyker with 109 maximum Toughness who Quells from 59% Peril down to 0% Peril, replenishes 59x(109x0.005)=32.15 Toughness." end}, -- toughness:5% warp_charge:10%. -- colors
...
{	id = "talent_tree_psy_pas_004_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Killing an Elite or a Speacialist Enemy applies {stacks:%s} Stacks of " .. soulblaze_rgb .. " to all nearby Enemies, causing " .. damage_rgb .. " over time.\n\n- Works at a distance of up to 4 meters from a killed enemy.\n- Does not proc on Elites or Specials killed by Soulblaze, Burn or Bleed ticks.\n- Soulblaze stacks additively with other sources of Soulblaze." .. soulblaze_stacks_warn_rgb end}, -- stacks:4. -- colors () Notice!
...
{	id = "talent_tree_psy_pas_005_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{damage:%s} Warp " .. damage_rgb .. " for {duration:%s} seconds on " .. crit_hits_rgb .. ". Stacks {stacks:%s} times.\n\n- Works for any Crits, even if you don't hit the enemy.\n- Stacks additively with other related damage buffs.\n- Warp attacks from any source are counted:\n-- Primary and Secondary attacks with Staves,\n-- Special attacks with Force swords,\n-- Blitz attacks and\n-- Soulblaze." end}, -- damage:+3% duration:10. stacks:5. -- colors s->seconds
...
{	id = "talent_tree_psy_pas_006_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{chance:%s} chance to Quell {warp_charge_percent:%s} " .. peril_rgb .. " on Kill.\n\n- Procs on Melee, Ranged and Soulblaze kills.\n- At 100% Peril, the Talent prevents the Psyker from self-exploding when triggered.\n- There is a 2% chance that the Talent procs on the same kill alongside \"Purloin Providence\" removing 25% Peril total." end}, -- chance:10% warp_charge_percent:10%. -- colors
...
{	id = "talent_tree_psy_pas_008_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Decreases " .. ability_cd_rgb .. " for you and Allies in Coherency by {cooldown:%s} on Elite or Speacialist Kill.\n\n- Does not stack with the same Talent from another Psyker.\n- This is 1.5 seconds for \"Venting Shriek\", \"Psykinetic's Wrath\" and \"Scrier's Gaze\", and 2 seconds for \"Telekine Shield\".\n- Indirectly interacts with Combat Ability Regeneration from Curios: The Curio stat Reduces the maximum Cooldown of the Combat Ability which then also decreases the flat amount of time Reduced by the Talent." end}, -- cooldown:5%. -- colors
...
{	id = "talent_tree_psy_pas_009_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Your Movement Speed is not reduced while Quelling " .. peril_rgb .. ".\n\n- Does not interact with Movement Speed buffs." end}, -- colors
...
{	id = "talent_tree_psy_pas_010_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{warp_damage:%s} " .. damage_rgb .. " to Warp Attacks for {duration:%s} seconds after a non-Warp based Kill. Stacks {stacks:%s} times.\n\n- Gains 1 Stack per kill with non-warp attacks.\n- Can be refreshed during active duration.\n- Warp attacks from any source are counted:\n-- Primary and Secondary attacks with Staves,\n-- Special attacks with Force swords,\n-- Blitz attacks and\n-- Soulblaze.\n- Stacks additively with other related Damage buffs." end}, -- warp_damage:+4% duration:8. stacks:5. -- colors
...
{	id = "talent_tree_psy_pas_011_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "When an Ally in Coherency gets Knocked Down, Replenish {toughness:%s} " .. toughness_rgb .. " to all other Allies in Coherency.\n\n- When Psyker goes down, replenishes Toughness to Allies in Coherency.\n- Does not proc when the Ally or Psyker dies." end}, -- toughness:50%. -- colors
...
{	id = "talent_tree_psy_pas_012_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Gain " .. toughness_dmg_rgb .. " Reduction of {min_damage:%s} to {max_damage:%s} based on your current " .. peril_rgb .. ".\n\n- Always grants a minimum of 10% Toughness Damage Reduction regardless of current Peril amount:\n______________________________\nPeril Amount:		TDR:\n0%			+10.00%\n20%			+14.60%\n40%			+19.20%\n50%			+21.50%\n60%			+23.80%\n80%			+28.40%\n100%			+33.00%\n______________________________\n- Stacks multiplicatively with other Damage Reduction buffs." end}, -- min_damage:+10.00% max_damage:+33.00%. -- colors
...
{	id = "talent_tree_psy_pas_013_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "A " .. crit_hit_rgb .. " makes you count as Dodging against Ranged Attacks for {duration:%s} second.\n\n- Procs on Melee, Ranged or Assail Critical Hit.\n- Can be refreshed during active duration." end}, -- duration:1. -- colors s->second
...
{	id = "talent_tree_psy_pas_014_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{dodge_linger_time:%s} Dodge duration. Increases the number of Dodges before Dodges starts becoming ineffective by {extra_consecutive_dodges:%s}.\n\n- Increases time from 0.2 seconds to 0.3 seconds which makes the dodge window more forgiving in regard to player input timing." end}, -- dodge_linger_time:+50% extra_consecutive_dodges:1.
...
{	id = "talent_tree_psy_pas_015_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return plus_rgb .. "{radius_modifier:%s} Radius for your Coherency Aura.\n\n- Increases base Coherency radius from 8 to 12 meters." end}, -- radius_modifier:50%.
...
{	id = "talent_tree_psy_pas_016_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Up to {max_damage:%s} " .. damage_rgb .. " from all sources, based on your current " .. peril_rgb .. ".\n\n- Higher Peril grants more Charges and Damage over time:\n______________________________\nPeril Amount:		Damage:\n0%			+0%\n20%			+4%\n40%			+8%\n50%			+10%\n60%			+12%\n80%			+16%\n100%			+20%\n______________________________\n- Stacks additively with other related Damage buffs." end}, -- max_damage:+20%. -- colors
...
{	id = "talent_tree_psy_pas_018_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Increases Quell Speed by {vent_speed:%s}.\n\n- Only applies to Active Quelling, Passive Quelling is not affected.\n- Stacks multiplicatively with Quell Speed buff from Celerity Stimm." end}, -- vent_speed:30%.
...
{	id = "talent_tree_zea_aura_001_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{damage_reduction:%s} " .. toughness_dmg_rgb .. " Reduction for you and Allies in Coherency.\n\nThis is an augmented version of the base Aura - {talent_name:%s}.\n\n- Stacks multiplicatively with other Damage Reduction buffs.\n- Does not Stack with the same Aura from another Zealot." end}, -- damage_reduction:+15%. talent_name:The Emperor's Will -- colors
--_____________________________________________________Aura 2
...
{	id = "talent_tree_zea_aura_002_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Removes {corruption:%s} " .. corruption_rgb .. " from the current Wound for you and Allies in Coherency every {interval:%s} second.\n\n- This rate is strong enough to counter a Grimoire's Corruption Damage tick rate. However, the initial 40 Corruption Damage per book cannot be removed." end}, -- corruption:1.5. interval:1. -- colors
--_____________________________________________________Aura 3
...
{	id = "talent_tree_zea_abil1_001_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{talent_name:%s} now has {charges:%s} charges.\n\n- The cooldown of the second charge only starts after the first charge finished cooldown." end}, -- talent_name:Fury of the Faithful charges:2.
-- _____________________________________________________Ability 1 Modifier 2
...
{	id = "talent_tree_zea_abil2_002_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Each pulse from {talent_name:%s} also " .. staggers_rgb .. " and Suppresses Enemies. Range increases with every pulse.\n\n- Spreads up to 10.5 meters.\n- Makes each pulse Stagger Melee enemies and Specials within 4 meters and Suppress Ranged enemies within 10 meters.\n- Staggers Monstrosities within 4 meters for 2 seconds on the 1st, 3rd, 5th and 7th pulse except Beast of Nurgle and weakly Staggers Scab Captain." end}, -- talent_name:Chorus of Spiritual Fortitude. -- & Notice!
-- _____________________________________________________Ability 2 Modifier 3
...
{	id = "talent_tree_zea_abil2_004_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{cooldown_restore:%s} of " .. health_rgb .. " " .. damage_rgb .. " taken is converted to " .. ability_cd_rgb .. " Reduction.\n\n- Does not proc while downed." end}, -- stacks:5 damage:+20%. duration:10. -- colors s->seconds {stacks:%s}
-- _____________________________________________________Ability 3
...
{	id = "talent_tree_zea_abil3_003_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Replenish {toughness:%s} " .. toughness_rgb .. " over {time:%s} seconds on leaving " .. stealth_rgb .. ". Also gain {damage:%s} " .. damage_rgb .. " Reduction for {time:%s} seconds.\n\n- When invisibility ends, replenishes 8% of maximum Toughness per second for 5 seconds.\n- Reduces both Toughness and Health Damage taken.\n- Stacks multiplicatively with other Damage Reduction buffs." end}, -- toughness:40% time:5. damage:+20% time:5. -- colors s->seconds
-- _____________________________________________________Ability 3 Modifier 4
...
{	id = "talent_tree_zea_keys1_000_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "When {max_stacks:%s} Enemies have died within {radius:%s} meters of you, you enter " .. fury_rgb .. " and get {crit_chance:%s} " .. crit_hit_chance_rgb .. " for {duration:%s} seconds.\n.\n- After 8 seconds without a kill, considers Zealot as being out of combat. While out of combat, drops Stacks of \"Fury\" over time. The dropping rate decreases with time.\n- Can be refreshed during active duration by killing enemies\n- Stacks additively with other sources of Crit Chance." end}, -- crit_chance:+15% duration:8. max_stacks:25 radius:25. -- rewrite colors m->meters s->seconds
-- _____________________________________________________Keystone 1 Modifier 1
...
{	id = "talent_tree_zea_keys1_001_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Triggering " .. fury_rgb .. " Replenishes {toughness:%s} " .. toughness_rgb .. ".\n\n- Also replenishes 2% of max Toughness per kill while at max Stacks of \"Fury\" and this Stacks additively with Zealot's base 5% max Toughness gained on Melee kill." end}, -- toughness:50%. -- colors
-- _____________________________________________________Keystone 1 Modifier 2
...
{	id = "talent_tree_zea_keys1_002_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "You gain one Stack of " .. fury_rgb .. " per Melee or Ranged " .. crit_hit_rgb .. ".\n\n- Can proc on multiple enemies Cleaved by a single Critical Hit, scales Extremely well with weapon Blessings like \"Brutal Momentum\"." end}, -- colors
-- _____________________________________________________Keystone 1 Modifier 3
...
{	id = "talent_tree_zea_keys1_004_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{crit_chance:%s} " .. crit_hit_chance_rgb .. " from {talent_name:%s}.\n\n- Increases Critical Strike Chance for all attacks that can Crit, additionally to \"Blazing Piety's\" base 15% Crit Chance." end}, -- crit_chance:+10% talent_name:Blazing Piety. -- colors
...
{	id = "talent_tree_zea_keys2_001_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{talent_name:%s} grants {toughness_damage_reduction:%s} " .. toughness_dmg_rgb .. " Reduction per missing " .. health_b_s_rgb .. ".\n\n- Up to 30% on Heresy/Damnation, up to 35% below.\n- A Health Segment counts as missing when it is fully depleted.\n- Stacks additively with Toughness Damage Reduction nodes.\n- The sum Stacks multiplicatively with other Toughness Damage Reduction buffs." .. wound_note_rgb end}, -- talent_name:Martyrdom toughness_damage_reduction:+5%. -- colors
-- _____________________________________________________Keystone 2 Modifier 2
...
{	id = "talent_tree_zea_keys2_002_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{talent_name:%s} grants {attack_speed:%s} Attack Speed per missing " .. health_b_ss_rgb .. ".\n\n- Up to 24% on Heresy/Damnation, up to 28% below.\n- A Health Segment counts as missing when it is fully depleted.\n- Stacks additively with other related attack Speed buffs." .. wound_note_rgb end}, -- talent_name:Martyrdom attack_speed:+4%. -- colors
...
{	id = "talent_tree_zea_pas_000_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{damage:%s} " .. damage_rgb .. " on your next Melee Attack for each Enemy Hit by your previous melee attack. Stacks {max_stacks:%s} times.\n\n- Increases the Melee Damage of your next Melee attack by 5% for each enemy hit by your previous Melee attack. Can only apply every other hit since it does not trigger while already active.\n- Gets 1 stack per enemy hit.\n- Damaging melee special actions of ranged weapons consume stacks (i.e. bashes with Bolter, Braced Autogun, Headhunter Autogun, Stub Revolver)." end}, -- damage:+5%. max_stacks:5. -- colors Notice!
...
{	id = "talent_tree_zea_pas_001_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{damage:%s} " .. damage_rgb .. " on Melee Backstab Hits.\n\n- \"Backstabbing\" refers to Melee attacks executed from within a specific angle behind an enemy's back.\n- Stacks additively with other related Damage buffs." end}, -- damage:+20%. -- colors -- colors
...
{	id = "talent_tree_zea_pas_002_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Up to {damage:%s} Base Ranged " .. damage_rgb .. ", reduced the further you are from the target.\n\n- Beyond 8 meters, the Damage buff decreases linearly until it loses its effect at 30 meters:\n______________________________\nDistance, m:		Damage:\n1			25%\n8			25%\n10			22.7%\n15			17%\n20			11.4%\n25			5.7%\n30			0%\n______________________________\n- Also increases the Damage of \"Blades of Faith\", \"Stunstorm Grenade\" and \"Immolation Grenade\" as well as DoTs like Burn and Bleed applied by Zealot as long as Zealot stays within 30 meters to the enemy and has the Ranged weapon equipped.\n- Note that Ranged weapons interact differently with this Talent depending on their individual effective Damage ranges: For example, the Infantry Lasgun MG 1a has inverted falloff and it deals mininum Damage within 7 meters to an enemy, then ramps up to max Damage at 15 meters and beyond. With the Talent equipped, the Damage falloff within 7 meters is effectively negated, its max Damage at 15 meters is increased and the Talent's regular falloff effect is active until 30 meters." end}, -- damage:+25%. -- colors Notice!
...
{	id = "talent_tree_zea_pas_003_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Melee " .. crit_hits_rgb .. " apply " .. bleed_rgb .. ", causing " .. damage_rgb .. " over time.\n\nMelee Hits on " .. bleeding_rgb .. " Enemies grant {crit_chance:%s} " .. crit_chance_rgb .. " for {duration:%s} seconds. Stacks {max_stacks:%s} times.\n\n- Can't apply bleed through shields.\n- Stacks additively with other sources of Crit Chance." end}, -- crit_chance:+10% duration:3. max_stacks:3. -- colors
...
{	id = "talent_tree_zea_pas_004_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Replenish {toughness:%s} " .. toughness_rgb .. " per second while within {range:%s} meters of at least {num_enemies:%s} Enemies.\n\n- Proximity check ignores map geometry.\n- Is inactive while being disabled by Pox Hound, Trapper, Mutant, Daemonhost, Chaos Spawn or Beast of Nurgle.\n- Does not interact with Coherency Toughness Regeneration." end}, -- toughness:2.5% range:5 num_enemies:3. -- colors
...
{	id = "talent_tree_zea_pas_005_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{toughness:%s} Coherency " .. toughness_rgb .. " Regeneration.\n\n- Increases Zealot's base amount of Coherency Toughness Regenerated while in Coherency:\n_______________________________\nAllies:			Toughness:\n1			3.75 -> 5.625\n2			5.625 -> 7.5\n3			7.5 -> 9.375\n_______________________________\n- Stacks multiplicatively with:\nOgryn's Aura - \"Stay Close!\",\nVeteran's node - \"Inspiring Presence\"\nand Toughness Regeneration Speed from Curios." end}, -- toughness:+25%. -- colors
...
{	id = "talent_tree_zea_pas_006_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{damage:%s} Increased " .. damage_rgb .. " against Infested and Unyielding Enemies.\n\n- Stacks additively with same Damage buffs from weapon Perks and related Damage buffs from Talents." end}, -- damage:+20%. -- colors
...
{	id = "talent_tree_zea_pas_007_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "The " .. toughness_rgb .. " you regain on Melee Kills is increased by {toughness:%s}.\n\n- Increases Zealot's base 5% of maximum Toughness gained on Melee kill to 7.5% of maximum Toughness gained on Melee kill." end}, -- toughness:+50%. -- colors
...
{	id = "talent_tree_zea_pas_009_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Replenish {toughness:%s} " .. toughness_rgb .. " on Heavy Attack Kill.\n\n- Replenishes toughness additionally to Zealot's base 5% of maximum Toughness gained on Melee kill." end}, -- toughness:7.5%. -- colors
...
{	id = "talent_tree_zea_pas_010_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Replenish {toughness:%s} " .. toughness_rgb .. " on Ranged Kill.\n\n- Does proc on throwing knife kills (Blades of Faith)." end}, -- toughness:2.5%. -- colors
...
{	id = "talent_tree_zea_pas_011_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "On taking " .. damage_rgb .. ", heal {damage_reduction:%s} of that " .. damage_rgb .. ". Occurs over {time:%s} seconds.\n\n- Procs only on Health Damage (also while in downed state).\n- Taking Damage while already regenerating Health, restores the correct amount of Health.\n- Also restores Health from Damage taken during \"Until Death\" as long as Zealot has more than 1 HP during its active duration (e.g. from a medical crate)." end}, -- damage_reduction:25%. time:5. -- colors s->seconds
...
{	id = "talent_tree_zea_pas_012_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Replenish {toughness:%s} " .. toughness_rgb .. " on a Successful Dodge.\n\n- Has a 0.5 seconds internal Cooldown.\n- Procs on successfully Dodging enemy Melee or Ranged attacks (except Gunners, Reapers, Snipers), and disabler attacks (Pox Hound jump, Trapper net, Mutant grab).\n- \"Successful dodge\" means Dodging an enemy attack that is locked on the player with an accordingly timed Dodge or sliding action.\n- \"The Ghost\", \"Hit and Run\" and \"Stripped Down\" weapon Blessings can proc this Talent (only against Ranged attacks)." end}, -- toughness:15%. -- colors
...
{	id = "talent_tree_zea_pas_013_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{toughness_damage_reduction:%s} " .. toughness_dmg_rgb .. " Reduction on " .. crit_hit_rgb .. " for {time:%s} seconds.\n\n- Can be refreshed during active duration.\n- Stacks multiplicatively with other Damage Reduction buffs." end}, -- toughness_damage_reduction:+50% time:4. -- colors s->seconds
...
{	id = "talent_tree_zea_pas_014_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Gives your Melee Attacks {impact:%s} " .. impact_rgb .. " strength and {attack_speed:%s} Attack Speed for {duration:%s} seconds after emptying your Ranged Weapon.\n\n- The attack speed buff Stacks additively with related buffs from \"Faithful Frenzy\", \"Fury of the Faithful\", \"Inexorable Judgement\", \"Maniac\" and Celerity Stimm.\n- The Stagger buff Stacks additively with related buffs from \"Grievous Wounds\", \"Hammer of Faith\" and \"Punishment\"." end}, -- impact:+30% attack_speed:+10% duration:5. -- colors and s->seconds
...
{	id = "talent_tree_zea_pas_015_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{spread:%s} Spread and {recoil:%s} Recoil for {duration:%s} seconds on successful Dodge.\n\n- Procs on successfully Dodging enemy Melee or Ranged attacks (except Gunners, Reapers, Snipers), and disabler attacks (Pox Hound jump, Trapper net, Mutant grab).\n- \"Successful dodge\" means Dodging an enemy attack that is locked on the player with an accordingly timed Dodge or sliding action.\n- \"The Ghost\", \"Hit and Run\" and \"Stripped Down\" weapon Blessings can proc this Talent (only against Ranged attacks)." end}, -- spread:-75% recoil:-50% duration:3. -- colors s->seconds
...
{	id = "talent_tree_zea_pas_016_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{damage:%s} Weakspot and " .. crit_hit_rgb .. " " .. damage_rgb .. " for {duration:%s} seconds on successful Dodge.\n\n- Procs on successfully Dodging enemy Melee or Ranged attacks (except Gunners, Reapers, Snipers), and disabler attacks (Pox Hound jump, Trapper net, Mutant grab).\n- \"Successful dodge\" means Dodging an enemy attack that is locked on the player with an accordingly timed Dodge or sliding action.\n- \"The Ghost\", \"Hit and Run\" and \"Stripped Down\" weapon Blessings can proc this Talent (only against Ranged attacks)." end}, -- damage:+50% duration:3. -- colors s->seconds
...
{	id = "talent_tree_zea_pas_017_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Fatal " .. damage_rgb .. " instead grants you Invulnerability for {active_duration:%s} seconds. Occurs every {cooldown_duration:%s} seconds.\n\n- \"Invulnerability\" means that Zealot's Health can't fall below 1. Zealot can still lose any Health above 1 while Invulnerable (e.g. taking hits when being healed by medical crate).\n- Does not prevent death from instakills like when thrown out of bounds into a map killbox." end}, -- active_duration:5. cooldown_duration:120. -- colors s->seconds
...
{	id = "talent_tree_zea_pas_018_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{cost:%s} Sprint Stamina cost.\n\n- Stacks multiplicatively with Sprint Efficiency perks from Curios, Ranged and Melee weapons, and Celerity Stimm." end}, -- cost:-20%.
...
{	id = "talent_tree_zea_pas_021_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "A successful Dodge grants {damage:%s} " .. damage_rgb .. " Reduction for {duration:%s} seconds.\n\n- Stacks multiplicatively with other Damage Reduction buffs.\n- Procs on successfully Dodging enemy Melee or Ranged attacks (except Gunners, Reapers, Snipers), and disabler attacks (Pox Hound jump, Trapper net, Mutant grab).\n- \"Successful dodge\" means Dodging an enemy attack that is locked on the player with an accordingly timed Dodge or sliding action.\n- \"The Ghost\", \"Hit and Run\" and \"Stripped Down\" weapon Blessings can proc this Talent (only against Ranged attacks)." end}, -- damage:+25% duration:2.5. -- colors s->seconds
...
{	id = "talent_tree_zea_pas_023_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "When {talent_name:%s} ends, you regain " .. health_rgb .. " based on the " .. damage_rgb .. " you dealt during {talent_name:%s}, to a maximum of {max_health:%s} Max " .. health_rgb .. ". Melee " .. damage_rgb .. " dealt heals for {melee_multiplier:%s} times that amount.\n\n- Leeches 0.7% of Damage dealt during the 5 second window of \"Until Death\".\n- Leech effect for Melee Damage is tripled: 2.1%.\n- Leech effect caps at 25% of maximum Health." end}, -- talent_name:Until Death max_health:25%. melee_multiplier:3. -- colors
...
{	id = "talent_tree_zea_pas_024_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{reload_speed:%s} Reload Speed on Melee Kill. Stacks {max_stacks:%s} times.\n\n- Stacks last until consumed upon reloading or loading special ammo (Combat Shotguns).\n- Stacks additively with related buffs from weapon Perks and Blessings, and Celerity Stimm.\n- This also increases the speed of the loading special action of Combat Shotguns." end}, -- reload_speed:+3%. max_stacks:10.
...
{	id = "talent_tree_zea_pas_025_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{stagger:%s} " .. impact_rgb .. " strength.\n\n- Increases Stagger strength for both Melee and Ranged attacks.\n- Stacks additively with related buffs from \"Grievous Wounds\", \"Punishment\" or \"The Emperor's Bullet\"." end}, -- stagger:+30%. -- colors
...
{	id = "talent_tree_zea_pas_026_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{impact_modifier:%s} " .. stagger_rgb .. " on Melee Weakspot Hits.\n\n- Applies to Melee special actions of Ranged weapons (i.e. bashes with Bolter, Braced Autogun, Headhunter Autogun, Stub Revolver).\n- Stacks additively with related buffs from \"Hammer of Faith\", \"Punishment\" or \"The Emperor's Bullet\"." end}, -- impact_modifier:+50%. -- colors
...
{	id = "talent_tree_zea_pas_027_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{damage:%s} " .. damage_rgb .. " to Ranged Backstab Attacks.\n\n- Increases damage by 20% when flanking.\n- \"Flanking\" refers to Ranged attacks executed from within a specific angle behind an enemy's back.\n- Stacks additively with the Raking Fire weapon Blessing and other related Damage buffs." end}, -- damage:+20%. -- colors
...
{	id = "talent_tree_zea_pas_028_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Melee Attacks that Hit at least {min_hits:%s} Enemies grant {impact_modifier:%s} " .. impact_rgb .. " Strength for {time:%s} seconds. Stacks {max_stacks:%s} times. At max Stacks gain Uninterruptible.\n\n- Stacks additively with related buffs from \"Grievous Wounds\", \"Hammer of Faith\" and \"The Emperor's Bullet\".\n- At max stacks, grants immunity to Stuns from both Melee and Ranged attacks (slowdown effects still apply), and makes Zealot's interact actions (e.g. reviving or object interactions) uninterruptible so that they cannot be canceled as part of hit reactions when taking Health Damage." end}, -- min_hits:3 impact_modifier:+30% time:5. max_stacks:5. -- colors s->seconds
...
{	id = "talent_tree_zea_pas_029_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{attack_speed:%s} Melee Attack Speed.\n\n- Stacks additively with related buffs from \"Fury of the Faithful\", \"Inexorable Judgement\", \"Maniac\", \"The Emperor's Bullet\" and Celerity Stimm." end}, -- attack_speed:+10%.
...
{	id = "talent_tree_zea_pas_030_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{damage:%s} Melee " .. damage_rgb .. " for {time:%s} seconds on Hitting an Enemy with a Melee Attack. Stacks {amount:%s} times.\n\n- Gets 1 Stack for each enemy hit.\n- Damaging Melee special actions from Ranged weapons also generate Stacks (i.e. bashes with Bolter, Braced Autogun, Headhunter Autogun, Stub Revolver).\n- Can be refreshed during active duration." end}, -- damage:+4% time:5. amount:5. -- colors s->seconds
...
{	id = "talent_tree_vet_blitz2_000_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Throw a grenade that deals devastating " .. damage_rgb .. ". Sticks to Flak Armoured, Carapace Armoured and Unyielding Enemies.\n\n- Explosion radius up to 4 meters.\n- Magnetizes from a short distance to heavily armored enemies: Reapers, Crushers, Bulwarks and Maulers.\n- Doesn't stick to the Scab Captain's energy shield." end}, -- colors Notice!
--_____________________________________________________Blitz 3
...
{	id = "talent_tree_vet_blitz3_000_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Throw a grenade that creates a lingering smoke cloud for {duration:%s} seconds. The cloud blocks line of sight for most enemies and reduces the sight range of enemies inside it.\n\n- Explosion radius up to 6 meters.\n- Doesn't affect the following ranged enemies: Snipers, Scab Bombers and Scab Flamers." end}, -- duration:15. -- colors Notice!
...
{	id = "talent_tree_vet_keys1_002_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{toughness_replenish_multiplier:%s} " .. toughness_rgb .. " Replenishment for each stack of " .. focus_rgb .. "." end}, -- toughness_replenish_multiplier:+2.5%. -- colors
--_____________________________________________________Keystone 1 Modifier 3
...
{	id = "talent_tree_vet_pas_008_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Your Kills Replenish an additional {toughness:%s} " .. toughness_rgb .. "." end}, -- toughness:3.5%. -- colors
...
{	id = "talent_tree_ogr_abil1_002_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "For each Enemy hit by {talent_name:%s} you gain a Stack of " .. trample_rgb .. " which increases Base " .. damage_rgb .. " by {damage:%s} for {duration:%s} seconds. Max Stacks {stack:%s}." end}, -- talent_name:Bull Rush damage:+1% duration:8. stack:25. -- rewrite colors s->seconds
--_____________________________________________________Ability 1 Modifier 3
...
{	id = "talent_tree_ogr_abil2_003_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{talent_name:%s} has " .. plus_rgb .. "{radius:%s} Radius." end}, -- talent_name:Loyal Protector radius:50%. -- colors
--_____________________________________________________Ability 3
...
{	id = "talent_tree_ogr_keys2_000_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "You are blessed with {stacks:%s} Stacks of " .. fnp_rgb .. ". Each Stack grants {toughness_regen:%s} " .. toughness_rgb .. " Replenishment and {damage_reduction:%s} " .. damage_rgb .. " Reduction.\n\nTaking " .. health_rgb .. " " .. damage_rgb .. " removes one stack. Stacks are restored every {duration:%s} seconds." end}, -- stacks:10 toughness_regen:+2.5% damage_reduction:+2.5%. duration:6. -- colors s->seconds
--_____________________________________________________Keystone 2 Modifier 1
...
{	id = "talent_tree_ogr_keys3_000_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{proc_chance:%s} chance of triggering " .. luckyb_rgb .. " and not consuming Ammo when making Ranged Attacks." end}, -- proc_chance:5%. -- colors
--_____________________________________________________Keystone 3 Modifier 1
...
{	id = "talent_tree_ogr_keys3_003_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Your chance of triggering " .. luckyb_rgb .. " is increased to {proc_chance:%s}." end}, -- proc_chance:8%. -- colors
...
{	id = "talent_tree_ogr_pas_002_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Replenish {toughness:%s} " .. toughness_rgb .. " after hitting multiple Enemies with a single Heavy Melee Attack." end}, -- toughness:25%. -- colors
...
{	id = "talent_tree_ogr_pas_004_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{toughness_regen:%s} " .. toughness_rgb .. " Regeneration while bracing your Ranged weapon." end}, -- toughness_regen:+2%. -- colors
...
{	id = "talent_tree_ogr_pas_005_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "Replenish {toughness:%s} " .. toughness_rgb .. " after hitting a single Enemy with a Heavy Melee Attack." end}, -- toughness:25%. -- colors
...
{	id = "talent_tree_ogr_pas_021_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "{rending_multiplier:%s} " .. rending_rgb .. " for {duration:%s} seconds on Elite Kill." end}, -- rending_multiplier:+15% duration:10. -- colors s->seconds
...
{	id = "talent_tree_ogr_pas_029_desc_en",
	...
	locales = {"en",},
	handle_func = function(locale, value)
	return "You take {damage_taken_multiplier:%s} reduced " .. damage_rgb .. " while bracing a Ranged Weapon." end}, -- damage_taken_multiplier:-15%. -- colors
